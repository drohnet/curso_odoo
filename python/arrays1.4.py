...
def continuar(continuar):
    if continuar == 'i':
        grabartxt(user, continuar)
        indice()
    if continuar == "tuplas" or continuar == 0:
        grabartxt(user, continuar)
        tuplas()
    if continuar == 1 or continuar == '1':
        grabartxt(user, continuar)
        acciones_tuplas()
    if continuar == 2 or continuar == '2':
        grabartxt(user, continuar)
        acciones_tuplas2()
    if continuar == 3 or continuar == '3':
        grabartxt(user, continuar)
        acciones_tuplas2_1()
    if continuar == 4:
        grabartxt(user, continuar)
...
print"--------------------------------------------------------------------------------"
print"--------------------------------------------------------------------------------"
print "Hola !!! Bienvenido al tutorial interactivo sobre las listas y las ltuplas en python:"
